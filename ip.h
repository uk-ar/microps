...
#define IP_ENDPOINT_STR_LEN (IP_ADDR_STR_LEN + 6) /* xxx.xxx.xxx.xxx.:yyyyyy */
...
extern ssize_t ip_output(uint8_t protocol, const uint8_t *data, size_t len, ip_addr_t src,
                         ip_addr_t dst);
